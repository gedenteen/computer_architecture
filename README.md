...
<p class="logo" align="center"><img src="https://imgur.com/UQeqNmM" height="100%" width="100%"></p>

## АРХИТЕКТУРА ВЫЧИСЛИТЕЛЬНОЙ МАШИНЫ SIMPLE COMPUTER
<p class="logo" align="center"><img src="https://imgur.com/4QYA0Nk" height="100%" width="100%"></p>
...
Регистры являются внутренней памятью процессора. Центральный процессор Simple Computer имеет: аккумулятор, используемый для временного хранения данных и результатов операций, счет- чик команд, указывающий на адрес ячейки памяти, в которой хранится текущая выполняемая ко- манда и регистр флагов, сигнализирующий об определѐнных событиях. Аккумулятор имеет разрядность 15 бит, счетчика команд – 7 бит. Регистр флагов содержит 5 разрядов: 
